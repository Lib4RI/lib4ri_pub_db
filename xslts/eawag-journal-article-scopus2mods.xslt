...
<xsl:stylesheet version="1.0"
  ...
  <xsl:variable name="internal_affiliation" select="/dtd:abstracts-retrieval-response/dtd:affiliation[dtd:affilname='Swiss Federal Institute of Aquatic Science and Technology']/@id" />
