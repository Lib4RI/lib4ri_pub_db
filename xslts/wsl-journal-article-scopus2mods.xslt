...
<xsl:stylesheet version="1.0"
  ...
  <xsl:variable name="internal_affiliation" select="/dtd:abstracts-retrieval-response/dtd:affiliation[dtd:affilname='Eidgenössische Forschungsanstalt fur Wald, Schnee Und Landschaft Eth-Bereichs']/@id" />
